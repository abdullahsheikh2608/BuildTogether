  ...
  return (
    <div className="mx-auto max-w-7xl">
      ...
      <div className="mb-8">
        ...
        <h1 className="mt-2 text-3xl font-bold text-paper">Welcome, {user?.full_name}</h1>
      ...
      <div className="grid gap-6 md:grid-cols-4">
        <div className="rounded-xl border border-slate-700 bg-slate-900 p-6">
          <h3 className="text-sm text-paper-dim">Total Applications</h3>
        ...
        <div className="rounded-xl border border-yellow-600 bg-slate-900 p-6">
          <h3 className="text-sm text-paper-dim">Pending</h3>
        ...
        <div className="rounded-xl border border-green-600 bg-slate-900 p-6">
          <h3 className="text-sm text-paper-dim">Accepted</h3>
        ...
        <div className="rounded-xl border border-red-600 bg-slate-900 p-6">
          <h3 className="text-sm text-paper-dim">Rejected</h3>
      ...
      <div className="mt-10">
        <h2 className="mb-5 text-xl font-semibold text-paper">Quick Actions</h2>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          >
            <h3 className="text-lg font-semibold text-paper">My Applications</h3>
          ...
          <div className="mt-5 space-y-4">
            {applications.slice(0, 3).map((app) => (
              <div key={app.id} className="rounded-lg border border-slate-700 p-4">
                ...
                <p className="text-sm text-paper-dim">{app.tagline}</p>
