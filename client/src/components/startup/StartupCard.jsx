        ...
        <div className="blueprint-card animate-draft-in flex flex-col gap-4 p-5">
            ...
            <div className="flex items-start justify-between gap-3">
                ...
                <span
                    className={`shrink-0 rounded-sm border px-2.5 py-1 font-mono text-[10px] font-semibold uppercase tracking-widest ${
                        isOpen
                            ? "border-ink-green text-ink-green"
                            : "border-paper-faint text-paper-faint"
                    }`}
                >
                    {startup.status}
                </span>
            ...
            <div className="flex flex-wrap gap-2">
                ...
                {startup.tech_stack?.map((tech) => (
                    ...
                    <span
                        key={tech}
                        className="rounded-sm bg-blueprint-800 px-2 py-1 font-mono text-xs text-cyan"
                    >
                        {tech}
                    </span>
...

                {
                    role === "founder" ? (
                        ...
                        <div className="flex flex-wrap gap-2">
                            ...
                            <Link
                                to={`/founder/startups/${startup.id}/applications`}
                            >
