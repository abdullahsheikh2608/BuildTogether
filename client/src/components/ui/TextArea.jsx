  ...
  return (
    <div className={`flex flex-col gap-1.5 ${className}`}>
      ...
      <textarea
        id={id}
        rows={4}
        className={`resize-y rounded-sm border bg-blueprint-800/60 px-3.5 py-2.5 text-sm text-paper
      ...
      />
      {hint && !error && (
        <span className="font-mono text-[11px] text-paper-faint">{hint}</span>
      )}
